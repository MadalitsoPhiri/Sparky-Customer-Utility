...
function App() {
 ...
 React.useEffect(()=>{
  socket.on("connect", () => {
    ...
    setConnected(true)
   socket.emit('agent-logged-in')
   });
   socket.on('num-agents',(number)=>{
    setagents(number)
  })

  socket.on('client-connected',(number)=>{
    setclients(number)
  })
  socket.on('client-disconnected',number=>{
    setclients(number)
  })
   socket.on("connect_error", (socket) => {
    ...
    return ()=>{
      socket.off('connect',(socket) => {
        console.log("unsubsribed"); // prints { x: "42", EIO: "4", transport: "polling" }
        setConnected(true)
       })
    }
   });
  ...
  return (
    ...
    <div className="flex flex-row w-screen h-screen">
     ...
     <div className="flex flex-col h-full py-2 bg-black-nav justify-between">
       ...
       <NavLink  to="/" className="group flex flex-col hover:bg-gray-active p-4 items-center w-full" onClick={()=>{
         setLocation('/')
       }}>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
       ...
       <NavLink  to="/agents" className="group flex flex-col hover:bg-gray-active p-4 items-center w-full"  onClick={()=>{
         setLocation('/agents')
       }}>
...
<p className={`text-xs ${location === "/agents" ?'text-gray-100' :'text-gray-inactive'} group-hover:text-gray-100`}>Agents</p>
              ...
              <NavLink  to="/chats" className="group flex flex-col hover:bg-gray-active p-4 items-center w-full" onClick={()=>{
                setLocation('/chats')
              }}>
        ...
        <p className={`text-xs ${location === "/chats" ?'text-gray-100' :'text-gray-inactive'} group-hover:text-gray-100`}>Chats</p>
                ...
                <NavLink to="/crm" className="group flex flex-col hover:bg-gray-active p-4 items-center w-full" onClick={()=>{
         setLocation('/crm')
       }}>
       ...
       <div className="flex flex-col  items-center max-w-full">
                ...
                <NavLink to="/profile" className="group flex flex-col hover:bg-gray-active p-4 items-center w-full" onClick={()=>{
                  setLocation('/profile')
                }}>
                ...
                <NavLink to="/settings" className="group flex flex-col hover:bg-gray-active p-4 items-center w-full" onClick={()=>{
     ...
     <div className="bg-gray-100 w-full">
       ...
       <div className="flex flex-row justify-center items-center w-full h-full">
         <div className="m-auto w-10/12 h-5/6 flex flex-col gap-20">
           <div className="w-full flex flex-row justify-between">
                ...
                <div className="flex flex-row gap-5">
                                        <div className="relative ">
                                              <div className="bg-blue-500 w-6 h-6 rounded-full absolute border-3  border-gray-100 -right-0 bottom-0 p-1">
                ...
                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546 2.916A5.986 5.986 0 0010 16a5.986 5.986 0 004.546-2.084A5 5 0 0010 11z" clip-rule="evenodd" />
                          ...
                          <div>
                <p className="px-4 py-2 border rounded-md font-bold border-gray-border text-black-nav cursor-pointer hover:bg-gray-200">Explore Sparky</p>
                          </div>
           ...
           <div className="w-full  flex flex-col border border-gray-border rounded-md divide-y divide-gray-border">
              <div className="flex flex-row ">
               <NavLink to="/chats" className="flex flex-1 flex-col bg-gray-100  hover:bg-gray-200 p-8"  onClick={()=>{
         setLocation('/chats')
       }}>
         ...
         setLocation('/chats')
               ...
               <NavLink to="/agents" className="flex flex-1 flex-col bg-gray-100  hover:bg-gray-200  p-8"  onClick={()=>{
         setLocation('/agents')
       }}>
